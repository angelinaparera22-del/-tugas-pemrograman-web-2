    ...
    <form method="POST" action="{{ route('ulasan.update', $ulasan->id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('pelanggan_id') is-invalid @enderror" id="pelanggan_id"
                name="pelanggan_id" value="{{ old('pelanggan_id', $ulasan->pelanggan_id) }}">
            @error('pelanggan_id')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_sepatu') is-invalid @enderror" id="nama_sepatu"
                name="nama_sepatu" value="{{ old('nama_sepatu', $ulasan->nama_sepatu) }}">
            @error('nama_sepatu')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('rating') is-invalid @enderror" id="rating"
                name="rating" value="{{ old('rating', $ulasan->rating) }}">
            @error('rating')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('komentar') is-invalid @enderror" id="komentar" name="komentar">{{ old('komentar', $ulasan->komentar) }}</textarea>
            @error('komentar')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tanggal_ulasan') is-invalid @enderror" id="tanggal_ulasan"
                name="tanggal_ulasan" value="{{ old('tanggal_ulasan', $ulasan->tanggal_ulasan) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('status') is-invalid @enderror" id="status"
                name="status" value="{{ old('status', $ulasan->status) }}">
            @error('status')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
